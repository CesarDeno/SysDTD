...
if (isset($_FILES["csvFile"])) {
    ...
    if ($fileType === 'text/csv') {
        ...
        if (file_exists($fileName) && is_readable($fileName)) {
            ...
            fclose($file);
            if ($updated) {
                echo '<script>alert("Registros actualizados correctamente.");</script>';
            } else {
        ...
        echo '<script>alert("El archivo seleccionado no es un archivo CSV válido.");</script>';
    }
}
else {
