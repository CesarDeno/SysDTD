...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div class="above-heading">
        <h2 class="h2-heading">Resultados del Test</h2>
        <div class="container-table">
            <div class="table-title">Datos de Alumnos</div>
            <div class="table-header">Nombre Alumno</div>
            <div class="table-header">Grado</div>
            <div class="table-header">Grupo</div>
            <div class="table-header">Diagnostico</div>
        </div>
    </div>  
